...
app.post('/campgrounds', validateCampground ,cathAsync(async (req, res, next)=>{
...
app.put('/campgrounds/:id', validateCampground ,cathAsync(
    async (req, res)=>{
        const { id } = req.params
...
app.post('/campgrounds/:id/reviews', validateReview ,cathAsync(async (req, res)=>{
...
app.delete('/campgrounds/:id/reviews/:reviewId', cathAsync( async (req, res)=>{
